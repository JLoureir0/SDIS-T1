...
//		ChunkBackup cb = null;
//		try {
//			cb = new ChunkBackup(db, fileID, path ,chunkNo, replicationDegree, chunkBody, mdbPort, InetAddress.getByName(address),mcPort,InetAddress.getByName(mcaddress));
//		} catch (Exception e1) {
//		}
//		cb.start();
//		
